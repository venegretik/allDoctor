...
export const consultationReducer = (state = defaultState, action) => {
    switch (action.type) {
        case CONSULTATION_ARRAY:
            return {
                ...state, consultation: [...action.consultation_array.items.filter(el => !el.is_upcomming)],
            };
        case HISTORY_ARRAY:
            return {
                ...state, consultationHistory: state.consultationHistory.concat(action.consultation_array.DoctorArray),
        ...
        case HISTORYCONS_ARRAY:
            return {
                ...state, consultationHistory: [...action.consultation_array.DoctorArray],
                page: action.consultation_array.page,
                totalPage: action.consultation_array.totalPage,
                specialization_id: action.consultation_array.specialization_id,
                date_from: action.consultation_array.date_from,
...
export const consultationHistoryConsAction = (consultation_array) => ({ type: HISTORYCONS_ARRAY, consultation_array })