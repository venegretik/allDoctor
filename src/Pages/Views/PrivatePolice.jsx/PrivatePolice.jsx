...
import { axiosPrivacy,axiosServices,axiosPersonal,axiosAgreemet } from "../../../base/asyncActions/getConfig";
...
const PrivatePolice = (props) => {
    ...
    useEffect(() => {
        ...
        dispatch(axiosPrivacy());
        if(params.type == "services")
        dispatch(axiosServices());
        if(params.type == "user")
        dispatch(axiosPersonal());
        if(params.type == "personal")
        dispatch(axiosAgreemet());
      }, []);
    return(
        <div className={s.PrivatePoliceFull}>
            <div>
            ...
            <div>
                <div className={s.Font_size14} dangerouslySetInnerHTML={{__html:HTML}}></div>
            </div>
        </div>
    )
}
