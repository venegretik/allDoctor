                ...
                <div className={s.Doctor_avatar}>
                  ...
                  <div className={s.Doctor_avatar_info + " " + s.black}>
                    ...
                    <p className={s.Font_size14}>
                      79% пациентов рекомендуют врача
                    </p>
                    <p className={s.Font_size14}>28 отзывов</p>
                  </div>
                </div>
                <div className={s.Doctor_info + " " + s.black}>
                  <p className={s.Doctor_skills + " " + s.Font_size14}>
                    Терапевт
                  </p>
                  ...
                  <p className={s.Font_size14}>
                    Стаж 19 лет • Врач высшей категории • Кандидат медицинских
                    наук
                  </p>
                </div>
              </div>
            ...
            <div className="slider__wrapper">
              <div className="slider__items">
                <div className="slider__item">
                  <img
                    src="https://api.telemed.dev-h.ru/images/icons/pain/zubi.svg"
                    alt=""
                  />
          ...
          <div className={s.medicine_cards}>
            <Link to="/doctor-list">
              <div className={s.card_item}>
                <img
                  src="https://api.telemed.dev-h.ru/images/icons/departments/dermatolog.svg"
                  alt=""
                />
