...
const Button = (props) => {
  const [isHover, setIsHover] = useState(false);
   ...
   const styleBlue = {
    backgroundColor: !isHover ? config?.config.colors.color10 : config?.config.colors.color6,
    color: config?.config.colors.color1
   };
   const styleOrange = {
    backgroundColor: !isHover ? config?.config.colors.color7 : config?.config.colors.color4,
    color: config?.config.colors.color2
   };
   const styleWhite = {
    backgroundColor: !isHover ? config?.config.colors.color1 : config?.config.colors.color4,
